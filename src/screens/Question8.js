    ...
    return (
        <View>
            ...
            <Animated.View style = {styles.bottomBox} >
                ...
                <Text style = {styles.bottomBody} >Q 8 to install Watchman when setting up the development environment for React Native on Mac OS? </Text>
            ...
            <Pressable style = {styles.button} onPress = {() => navigation.navigate("Question9")}>
